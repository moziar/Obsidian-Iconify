...
class IconSwapperSettingsTab extends obsidian.PluginSettingTab {
    constructor(app, plugin) {
        super(app, plugin);
        this.plugin = plugin;
        this.customIconsContainer = null;
        this.defaultIconsContainer = null;
    }
    ...
    refreshCustomIcons() {
        ...
        if (Object.keys(customIcons).length > 0) {
            ...
            for (const iconName in customIcons) {
                ...
                // 显示图标和名称
                iconSetting.nameEl.createDiv({cls: 'icon-swapper-container'}, (container) => {
                    container.createDiv({cls: 'icon-swapper-icon'}, (icon) => {
                        try {
                            obsidian.setIcon(icon, iconName, 20);
                        } catch (e) {
    ...
    display() {
        ...
        // 创建自定义图标列表容器
        this.customIconsContainer = containerEl.createDiv({cls: 'custom-icons-list-container'});
